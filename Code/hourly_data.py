...
'''for i in range(1,6):
 ...
 '''
url = f'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY_EXTENDED&symbol=GME&interval=60min&slice=year1month6&apikey={api_key}'
#this returns a CSV
res = requests.get(url)
open(f'Data/6_months_before_.csv', 'wb').write(res.content)